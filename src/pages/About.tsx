  ...
  return (
    <>
      ...
      <p id="about-me-subheading">
        dropping a few photos & a video here and there at random . . .
      </p>
      <img
        id="about-me-pic-one"
        src="https://i.postimg.cc/52rXXdxG/About-Page-1.jpg"
      />
      <p>
      ...
      <img
        id="about-me-pic-two"
        src="https://i.postimg.cc/267jFPD2/About-Page-2.jpg"
      />
      ...
      <img
        ...
        src="https://i.postimg.cc/J42rqN92/About-Page-3.jpg"
      />
      <p>
      ...
      <YouTube videoId="gEFOBf0yPUM" id="about-me-video-one" opts={opts} />
      <p>
      ...
      <img
        id="about-me-pic-four"
        src="https://i.postimg.cc/q78p49gD/About-Page-4.jpg"
      />
      <p>
