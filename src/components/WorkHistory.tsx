    ...
    <section id="work-history-wrapper" className="section--page">
      ...
      <div className="card--work-history">
        ...
        <p>
          ...
          <span>Skills:</span>
          <ul>
            <li>React.js (Open-Source JavaScript Library)</li>
            <li>
              Redux (JavaScript Library Used for Managing the State of
              Applications)
            </li>
            <li>
              TypeScript (Adds Static Typing With Optional Type Annotations to
              Javascript)
            </li>
            <li>JavaScript (Programming Language)</li>
            <li>HTML5 (Standard Language Used to Create Web Pages)</li>
            <li>CSS3 (Used to Style and Layout Web Pages)</li>
            <li>Visual Studio Code (Integrated Development Environment)</li>
            <li>
              Postman (Test and Manage API Responses While Developing or
              Modifying an API)
            </li>
          </ul>
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            Quotient (TQ).
            <br />
            *topics passed in TQ are: Quantum Computing, XR and the Metaverse,
            Security, Data, Sustainability & Technology, 5G & Edge Computing,
            Enterprise Platforms, Agile & DevOps, Cloud, Blockchain, Automation,
            AI, Generative AI, Gen AI 2.0.
          </li>
          <li>
            Completed A Cloud Guru's AWS Certified Cloud Practitioner (CLF-C01)
          </li>
