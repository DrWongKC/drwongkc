    ...
    <>
      <div id="container--main">
        <section id="wrapper--hero" className="section--page">
          <img id="profile-pic" src="/src/assets/images/kaichong-141.jpg" />

          <div>
            <h1 id="user-name">Kai Chong, Wong</h1>
            <p id="bio">
              Software developer, developer advocate at{" "}
              <a href="https://www.appwrite.io/" target="_blank">
                Appwrite
              </a>
              , Udemy{" "}
              <a
        ...
        <section id="work-history-wrapper" className="section--page">
          ...
          <div className="card--work-history">
            ...
            <p>9/2023 - present</p>
            <p>
              <strong>[Current Challenge]</strong> Working to improve developer
              adoption and experience across all Appwrites SDKs through
              educational content on the Appwrite{" "}
              <a href="https://www.youtube.com/appwrite" target="_blank">
                Youtube channel
              </a>
              ,{" "}
              <a
                href="https://appwrite.io/blog/author/dennis-ivy"
                target="_blank"
              >
                articles
              </a>
              , &{" "}
              <a href="https://www.youtube.com/live/VJvawxeUhN4">
                community events
              </a>
            </p>
          ...
          <div className="card--work-history">
            ...
            <ul>
              ...
              <li>
                ...
                E-commerce, real-time video, stripe & PayPal integrations, and
                more{" "}
              </li>
            </ul>
          </div>
          ...
          <div className="card--work-history">
            ...
            <ul>
              ...
              <li>
                Built the entire code base and brought version 1.0 of the LIMS
                system to market as a solo developer
              </li>
              <li>Onboarded and trained customers (Webinars & Conferences)</li>
              <li>
                Managed a small team of developers in the expansion of the LIMS
                system
              </li>
            </ul>
          </div>
